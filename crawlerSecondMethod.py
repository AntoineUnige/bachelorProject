...
''' Seconde METHODE DANS LAQUELLE ON CHOISIT UN LIEN ALEATOIRE'''
...
def pertinence(url, keyword, count):
    ...
    try:
        ...
        print(count, "occurences du mot ", keyword, "pour la page: ", url, "sur: ", totalMots, "mots au total")
        return count
    except Exception as e:
        print(str(e))    
